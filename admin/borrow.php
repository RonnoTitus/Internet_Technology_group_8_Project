...
// Available books (not currently borrowed)
...
<div class="main-content">
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p>Full borrowing management and history</p>
        </div>
    </div>
            ...
            <div class="table-wrap">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="<?php echo $isOver ? 'overdue-date' : 'muted'; ?>"><?php echo date('M j, Y', strtotime($r['return_date'])); ?></td>
