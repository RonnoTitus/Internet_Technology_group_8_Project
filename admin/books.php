...
if (isset($_GET['delete'])) {
    ...
    // Cascade deletes BOOK_AUTHOR, BOOK_PUBLISHING, BORROWED_BOOKS via FK ON DELETE CASCADE
...
if (isset($_GET['edit'])) {
    $edit = true;
    $id   = intval($_GET['edit']);
    $row  = mysqli_fetch_assoc(mysqli_query($conn, "SELECT b.BookID, b.Title,
        GROUP_CONCAT(DISTINCT a.AuthorName ORDER BY a.AuthorName SEPARATOR ', ') AS authors,
        MAX(p.PublisherName) AS publisher,
        MAX(bp.Year) AS pub_year
        FROM BOOK b
...
if (isset($_POST['update'])) {
    ...
    if (!$aRow) {
        mysqli_query($conn, "INSERT INTO AUTHOR(AuthorName) VALUES('$authorStr')");
    ...
    if (!$pRow) {
        mysqli_query($conn, "INSERT INTO PUBLISHER(PublisherName) VALUES('$pubName')");
        $pubId = mysqli_insert_id($conn);
    } else {
        $pubId = $pRow['PublisherID'];
    }
...
<div class="main-content">
    <div class="page-header">
        <div class="page-header-left">
            <h2>Books</h2>
            <p><?php echo $totalBooks; ?> total books in catalog</p>
        </div>
    </div>
    <div class="split-layout">
        ...
        <div class="card">
            ...
            <div class="table-wrap">
                <table>
                    <thead>
                        <tr><th>#</th><th>Title</th><th>Author(s)</th><th>Publisher</th><th>Year</th><th>Status</th><th>Actions</th></tr>
                    </thead>
                    <tbody>
                    ...
                    <tr>
                        ...
                        <td style="display:flex;gap:6px;">
                            ...
                            <a href="?delete=<?php echo $row['BookID']; ?>" class="btn btn-danger btn-sm"
